...
namespace POSMainForm
{
    public partial class frmDatabaseConfig : Form
    {
        ...
        private void cmdTest_Click(object sender, EventArgs e)
        {
            ...
            TstServerMySQL = "localhost";
            TstDBNameMySQL = "posisdb_csharp";
            TstUserNameMySQL = "root";
            TstPwdMySQL = "";
            

            try
            {
                SQLConn.conn.ConnectionString = "Server = '" + TstServerMySQL + "'; " + "Database = '" + TstDBNameMySQL + "'; " + "user id = '" + TstUserNameMySQL + "'; " + "password = '" + TstPwdMySQL + "'";
