    ...
    public partial class frmReportDailSalesByInvoice : Form
    {
        ...
        private void LoadReport()
        {
            try
            {
                ...
                SQLConn.sqL = "SELECT T.invoiceNo as InvNo ,T.Tdate as Date,TD.itemName as Item ,TD.Quantity,TD.ItemPrice as Price , (TD.ItemPrice*TD.quantity) as Total ,T.customer FROM Transactions as T, TransactionDetails as TD where T.Tdate = '" + ReportDate.ToString("MM/dd/yyyy") + "'";
                SQLConn.ConnDB();
